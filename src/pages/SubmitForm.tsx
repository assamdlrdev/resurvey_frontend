    ...
    <div className="min-h-screen bg-gradient-to-br from-medical-50 to-medical-100 p-4">
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-medical-900 mb-2">Submit Form</h1>
          <p className="text-medical-600">Toggle between data reference view and input form</p>
        </div>
